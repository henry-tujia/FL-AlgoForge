...
class Trainer:
    ...
    def read_config_and_create_logger(self):
        ...
        f.close()
        with open(
            self.config_path.parent / (f"{self.method}.yaml"), "r", encoding="utf-8"
        ) as f:
    ...
    def init_dataloaders(self):
        ...
        (
            ...
            self.settings["partition_method"],
            self.settings["partition_alpha"],
            self.settings["client_number"],
        )
    ...
    def init_methods(self):
        ...
        match self.method:
            ...
            case "feddecorr":
                ...
                model_paras["KD"] = True
            case "fedunknown":
                self.Server = fedunknown.Server
                self.Client = fedunknown.Client
                model_paras["KD"] = True
            case "fedprox":
            ...
            case "fedfv":
                ...
                self.server_dict["hypers"] = hypers
            case _:
                raise ValueError(
